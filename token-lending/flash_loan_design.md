...
You can view a sample implementation [here](https://github.com/solana-labs/safecoin-program-library/tree/master/token-lending/program/tests/helpers/flash_loan_receiver.rs).
