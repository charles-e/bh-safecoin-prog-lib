...
pub fn process_instruction(
    ...
    let spl_token_id_mint_info = next_account_info(account_info_iter)?;
    let system_program_info = next_account_info(account_info_iter)?;
    let spl_token_id_program_info = next_account_info(account_info_iter)?;
    let spl_token_id_program_id = spl_token_id_program_info.key;
    ...
    let associated_token_account_signer_seeds: &[&[_]] = &[
        ...
        &spl_token_id_program_id.to_bytes(),
        &spl_token_id_mint_info.key.to_bytes(),
        &[bump_seed],
    ];
    ...
    invoke_signed(
        &system_instruction::assign(associated_token_account_info.key, &spl_token_id_program_id),
        &[
            associated_token_account_info.clone(),
            system_program_info.clone(),
        ],
